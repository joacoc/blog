    ...
    const content = (
        <>
            <p>
                ...
                As the founder said: <a className="no-underline hover:underline text-blue-500" href="https://amasad.me/replit_ide">Repl.it is not an IDE</a> 
                ...
                And without the hardware requirements for compiling.<br/> <br/>
